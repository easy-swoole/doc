...
<head>
    ...
    <meta name="description" content="EasySwoole is a resident memory-based distributed swoole framework based on swoole . It is designed for APIs and gets rid of the performance loss caused by process evoke and file loading in traditional PHP running mode"/>
    {literal}
    <style>
