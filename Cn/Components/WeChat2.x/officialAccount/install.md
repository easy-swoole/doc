...
# 微信SDK EasySwoole WeChat 2.x - 公众号
...
::: tip
 注意：`WeChat` 组件目前最新版本为 `2.0.0` 版。完全不兼容旧版本 `wechat 1.2.x` 版本。旧版本 `1.2.x` 微信公众号组件的文档请移步查看 `1.2.x` 微信公众号 `SDK` 文档的 [安装](https://github.com/easy-swoole/wechat/blob/1.2.x/docs/install.md) 和 [API 接口](https://github.com/easy-swoole/wechat/blob/1.2.x/docs/officialAccount.md)
:::
