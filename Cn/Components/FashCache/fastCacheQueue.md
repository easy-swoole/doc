---
title: easyswoole fastcacheQueue
meta:
  - name: description
    content: easyswoole fastcacheQueue,利用swoole自定义进程实现简单的本机缓存队列
  - name: keywords
    content:  easyswoole fastcacheQueue
---
...
::: warning 
 FastCacheQueue依托于FastCache，具体安装请查看[FastCache](fastCache.html)
:::
###  服务注册
